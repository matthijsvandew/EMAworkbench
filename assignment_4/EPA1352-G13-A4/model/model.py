...
class BangladeshModel(Model):
    ...
    def __init__(self,file, seed=None, x_max=500, y_max=500, x_min=0, y_min=0,scenario=0,replication=0):
        ...
        self.dict_scenario = {} # Load in the changes that a bridge with a certain condition is broken.
    ...
    def generate_model(self):
        ...
        # Specify the route a vehicle should take when it is generated by a specific sourcesink.
    ...
    def get_route(self, source):
        return self.get_straight_route(source) # Choose a straight destination.
