...
class BangladeshModel(Model):
    ...
    def __init__(self, seed=None, x_max=500, y_max=500, x_min=0, y_min=0,scenario=0,replication=0):
        ### Notice that the model receives input from which scenario and replication it runs
        ### This will be used to store the scenario and replication number in the dataframe
    ...
    def generate_model(self):
        ...
        df = pd.read_csv(r'../data\input_data_n1.csv') ### Read the data which contains all bridges and roads
        ...
        for df in df_objects_all:
            for _, row in df.iterrows():    # index, row in ...
                ...
                if model_type == 'source':
                    ...
                    ### Notice that the bridge receives the scenario number. This will be used to determine
                    ### whether the bridge breaks depending on the condition (A,B,C,D), scenario and a random factor
